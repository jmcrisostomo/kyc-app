          ...
          <div class="container" style="max-width: 700px;">
            ...
            <div id="requiredFields" class="d-none">
              ...
              <div class="mb-3">
                ...
                <input id="inputReceiverAccountName" class="form-control" type="text" placeholder="Required" readonly>
              </div>

              <div class="mb-3">
                <label for="inputReceiverAccountNumber" class="fw-bold text-light mb-1">Receiver Account #</label>
                <input id="inputReceiverAccountNumber" class="form-control" type="text" placeholder="Required" readonly>
              </div>

              <div class="mb-3">
                <label for="inputReceiverCardNumber" class="fw-bold text-light mb-1">Receiver Card #</label>
                <input id="inputReceiverCardNumber" class="form-control" type="text" name="card_number" placeholder="(Optional)" readonly>
              </div>
              ...
              <div class="mb-3">
                ...
                <input id="inputSenderAccountName" class="form-control" type="text" name="account_name" placeholder="Required" required>
              </div>

              <div class="mb-3">
                <label for="inputSenderAccountNumber" class="fw-bold text-light mb-1">Sender Account #</label>
                <input id="inputSenderAccountNumber" class="form-control" type="text" name="account_number" placeholder="Required" required>
              </div>

              <div class="mb-3">
                <label for="inputSenderCardNumber" class="fw-bold text-light mb-1">Sender Card #</label>
                <input id="inputSenderCardNumber" class="form-control" type="text" name="card_number" placeholder="(Optional)">
              </div>

              <div class="mb-3">
                <label for="inputAmount" class="fw-bold text-light mb-1">Amount (Min: <span id="spanMinDeposit"></span>; Max: <span id="spanMaxDeposit"></span>;)</label>
              ...
              <div class="mb-3">
                ...
                <textarea id="textAreaNotes" class="form-control" rows="4" name="notes" placeholder="(Optional)"></textarea>
              </div>

              <div class="mb-3">
                <input class="form-control" id="inputDepositFile" style="" type="file" name="Add_Image" accept=".jpeg,.jpg,.png,.bmp,.tiff,.tif" required>
              </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/player.deposit.js'); ?>"></script>